// src/components/Admin/ChunkingSettings/ChunkingSettingsList.tsx
import { ChevronLeftIcon, ChevronRightIcon } from '@heroicons/react/20/solid';
import { Link } from 'react-router-dom';
import { ChunkingSettings } from '../../../types/chunkingSettings';

interface ChunkingSettingsListProps {
...
const ChunkingSettingsList = ({
  settings,
  onDelete,
  currentPage,
  totalPages,
  onPageChange,
}: ChunkingSettingsListProps) => {
  return (
              ...
              settings.map((setting) => (
                <tr key={setting.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <Link
                      to={`/admin/chunking-settings/${setting.id}`}
...
export default ChunkingSettingsList;